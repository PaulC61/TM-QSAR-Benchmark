"""Quantile binarizer used to convert continuous descriptors (e.g. RDKit2D)
into the binary features Tsetlin Machines require.

Moved unchanged from the former top-level `tm_binarizer.py`.
"""
...
class Binarizer:
    """Bins each continuous feature into `resolution + 2` binary thresholds
    based on quantiles observed at `fit` time."""
