...
MACRO_OUT_FILENAME = "results/MACRO_TM_Benchmark_8_para"
MICRO_OUT_FILENAME = "results/MICRO_TM_Benchmark_8_para"
...
def benchmark_CLF_objective(trial, X_train_in, X_val_in, Y_train_in, Y_val_in, model_label, param_grid):
    ...
    if model_label != "TsetlinMachine":
        ...
        for epoch in range(int(N_TM_EPOCHS*0.5)):
            ...
            Y_val_css = clf_model.score(X_val_in)[:, 1]
            Y_val_pred_prob = expit(Y_val_ccs/clf_model.T)
